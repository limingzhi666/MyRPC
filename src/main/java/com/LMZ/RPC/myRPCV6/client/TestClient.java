...
import com.LMZ.RPC.myRPCV6.client.Netty.NettyClient;
import com.LMZ.RPC.myRPCV6.common.entity.Blog;
import com.LMZ.RPC.myRPCV6.common.entity.User;
...
public class TestClient {
    public static void main(String[] args) {
        ...
        RPCClient rpcClient = new NettyClient(new RandomLoadBalance()); //可以选择负载均衡方式
        // 把这个客户端传入代理客户端
